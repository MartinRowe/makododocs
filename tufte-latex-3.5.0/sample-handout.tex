...
\title{Martin's Example of the Usage of the Tufte Style\thanks{Inspired by Martin Rowe!}}
...
\begin{abstract}
\noindent The pity is that I can't change Latex to CSS \LaTeX\ document style.
